...
image::hip-0004/b.jpg[blockdag,513]
...
image::hip-0004/s.png[phantom,513]
...
image::hip-0004/p.png[SPECTRE,436,396]

TODO: Total ordering to solve fair reward mechanism

Block DAG achieves consensus on the order of all events in it, HLC can easily extend this agreement to achieve consensus on the state . It simply iterate over all transactions according to the agreed order, and accept each transaction that is consistent with those accepted so far. 