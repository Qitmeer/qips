...
## Abstract
Now the HLC block size is 124,the type of the time in header is `uint32`,we increase the size of the time,from `uint32` to `uint64`.
...
see https://github.com/HalalChain/qitmeer/blob/master/core/types/block.go[Qitmeer]
