...
1. QIPs should be written in markdown format. Image files should be included in a subdirectory for that QIP. ex: [hip-0001.asciidoc](hip-0001.asciidoc)'s images files should be included in the [hips/hip-0001](hip-0001) subdirectory of the QIPs repository.
